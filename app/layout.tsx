...
export const metadata: Metadata = {
  ...
  title: {
    default: 'CrateFit - 3D Bin Packing Made Simple',
    template: '%s | CrateFit',
  },
  description:
    'Open-source 3D bin packing library for container loading, pallet packing, and logistics optimization. TypeScript native with real-time visualization.',
  keywords: [
    'bin packing',
    '3d packing',
    'container loading',
